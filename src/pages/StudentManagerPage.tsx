      ...
      {loading ? (
        ...
        <table className="student-table">
          ...
          <tbody>
            {students.length === 0 ? (
              <tr>
                <td colSpan={canEdit ? 6 : 5} style={{ textAlign: 'center', padding: 20 }}>
              ...
              students.map((s, index) => (
                <tr key={s.id}>
                  ...
                  <td
                    style={{ color: s.is_locked ? 'red' : 'green', fontSize: 13, fontWeight: 500 }}
                  >
          ...
          <div className="modal-content">
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, group_number: parseInt(e.target.value) || 0 })
                }
              />
            </div>
