    ...
    <div className="report-page-container">
      ...
      <div className="filter-section">
        ...
        <div className="filter-group">
          ...
          <select value={violationTypeId} onChange={(e) => setViolationTypeId(e.target.value)}>
          ...
          >
            ...
            <ResponsiveContainer width="100%" height={350}>
              <BarChart data={chartGroupStats}>
                ...
                {}
                <Bar dataKey="penalty" name="Điểm Trừ" fill="#FF4560" barSize={30} />
              </BarChart>
            </ResponsiveContainer>
          </div>
          ...
          >
            ...
            <ResponsiveContainer width="100%" height={350}>
              <BarChart data={chartGroupStats}>
                ...
                <Bar dataKey="violationCount" name="Số lần vi phạm" fill="#FFBB28" barSize={50} />
              </BarChart>
            </ResponsiveContainer>
          </div>
